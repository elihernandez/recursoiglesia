/*
  ...
  - Added the required column `resourceId` to the `Attempt` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `attempt` ADD COLUMN `resourceId` VARCHAR(191) NOT NULL;
